...
public class MergeWithToc {
    ...
    public static final String SRC1 = "C:\\Porto\\POC_DOCS\\produto.pdf";
    public static final String SRC2 = "C:\\Porto\\POC_DOCS\\servicos.pdf";
    public static final String SRC3 = "C:\\Porto\\POC_DOCS\\toc.pdf";
    public static final String DEST = "C:\\Porto\\POC_DOCS\\saida.pdf";
    ...
    public MergeWithToc() throws IOException {
        ...
        filesToMerge.put("Serviços", new PdfReader(SRC2));
    }
