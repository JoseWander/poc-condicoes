...
public class Main extends PdfPageEventHelper
{
    ...
    private final Map<String, Integer>     pageByTitle    = new HashMap<String, Integer>();
    ...
    public Main() throws Exception
    {
        ...
        this.writer = PdfWriter.getInstance(this.document, new FileOutputStream("C:\\Porto\\POC_DOCS\\text.pdf"));
